{
  description = "Echo - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          echo = pkgs.rustPlatform.buildRustPackage {
            pname = "echo";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/master5d/Echo";
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.echo.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.echo;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.echo.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.echo;
        };
