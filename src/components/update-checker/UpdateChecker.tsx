          ...
          <div className="bg-bg border border-border rounded-lg p-6 max-w-md w-full mx-4 space-y-4">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                ...
                onClick={() => {
                  openUrl("https://github.com/master5d/Echo/releases/latest");
      ...
      <div className={`flex items-center gap-3 ${className}`}>
        {isUpdateClickable ? (
          <button
            ...
            className={`transition-all duration-300 disabled:opacity-50 tabular-nums ${
              updateAvailable
                ? "text-indigo-400 hover:text-indigo-300 font-black tracking-wide bg-indigo-500/10 px-2 py-0.5 rounded-md"
